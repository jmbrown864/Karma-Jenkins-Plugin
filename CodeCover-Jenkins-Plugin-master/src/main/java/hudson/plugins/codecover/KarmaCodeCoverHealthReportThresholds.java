 ...
 * @since 1.7
 */
public class KarmaCodeCoverHealthReportThresholds implements Serializable {
    ...
    public KarmaCodeCoverHealthReportThresholds() {
    }

    public KarmaCodeCoverHealthReportThresholds(int minStatement, int maxStatement, int minBranch, int maxBranch, int minLoop, int maxLoop, int minCondition, int maxCondition) {
