    ...
    YAHOO.extend(Panel, Overlay, {
        ...
        */
        ...
        _addFocusHandlers: function(p_sType, p_aArgs) {
            ...
            this._setTabFunction(this.firstElement, this.lastElement);
        ...
        /**
         * Protected internal method for setTabFunction, which can be used by 
         * subclasses to jump in and modify the arguments passed in if required.
         *
         * @method _setTabFunction
         * @param {HTMLElement} firstElement
         * @param {HTMLElement} lastElement
         * @protected
         *
         */
        _setTabFunction : function(firstElement, lastElement) {
            this.setTabFunction(firstElement, lastElement);
        },

        /**
         * Sets up a tab, shift-tab function between the first and last elements
         ...
         *
         * @method setTabFunction
         * @param {HTMLElement} firstElement
         * @param {HTMLElement} lastElement
         *
         */
        setTabFunction : function(firstElement, lastElement) {
    ...
    YAHOO.extend(Dialog, YAHOO.widget.Panel, { 
        ...
        */
        ...
        setTabFunction : function(firstElement, lastElement) {
            ...
            Dialog.superclass.setTabFunction.call(this, firstElement, lastElement);
        },
