	...
	StorageEngineHTML5.isAvailable = function() {
        try {
            ...
            /*
                ...
                will cause an error to be thrown instead of evaluating the simple if/else line.
             */
            return false;
        }
    };
 ...
 *  - no query should insert or update more than 9948 bytes of data in a single line or GEARs will throw:
 *  	[Exception... "'Error: SQL line is too long.' when calling method: [nsIDOMEventListener::handleEvent]" nsresult: "0x8057001c (NS_ERROR_XPC_JS_THREW_JS_OBJECT)" location: "<unknown>" data: no]
 *
 * Thoughts:
