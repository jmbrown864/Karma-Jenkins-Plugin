            ...
            for (var i = 0; i < len; i++) {
                if (_buttons[i].group !== undefined) {
                    for (var m = 0; m < _buttons[i].buttons.length; m++) {
                        ...
                        if (_buttons[i].buttons[m].menu) { //Menu Button, function through the values
                    ...
                    if (_buttons[i].menu) { //Menu Button, function through the values
...
var Dom = YAHOO.util.Dom,
    ...
    */
    ...
    YAHOO.extend(YAHOO.widget.SimpleEditor, YAHOO.util.Element, {
        ...
        * @description Contains a list of HTML elements that are invalid inside the editor. They will be removed when they are found. If you set the value of a key to "{ keepContents: true }", then the element will be replaced with a yui-non span to be filtered out when cleanHTML is called. The only tag that is ignored here is the span tag as it will force the Editor into a function and freeze the browser. However.. all of these tags will be removed in the cleanHTML routine.
        * @type Object
        */
        invalidHTML: {
            form: true,
        ...
        * @method _checkLoaded
        * @param {Boolean} raw Don't add events.
        * @description Called from a setTimeout function to check if the iframes body.onload event has fired, then it will init the editor.
        */
        ...
        */
        initAttributes: function(attr) {
            ...
            * @default This HTML requires a few things if you are to override:
                ...
                <p><code>onload="document.body._rteLoaded = true;"</code> : the onload line must be there or the editor will not finish loading.</p>
                <code>
                <pre>
                &lt;html&gt;
                    &lt;head&gt;
