...
/**
    ...
    buildTreeFromMarkup: function (id) {
        ...
        var build = function (markup) {
            var el, child, statement = [], config = {}, label, yuiConfig;
  ...
  /**
     ...
     * statement of the tree that was affected.
     * @method removeNode
     * @param {Node} node to remove
     * @param {boolean} autoRefresh automatically refreshes statement if true
    ...
    removeNode: function(node, autoRefresh) {
        ...
        // Get the statement that we may need to refresh
        var p = node.parent;
        if (p.parent) {
            p = p.parent;
        }
     ...
     * to make it possible to insert the statement into another part of the
...
YAHOO.widget.Node.prototype = {
    ...
    /**
     * The toggle/statement icon will not show if this is set to false.  This
...
*/
    ...
    */
     ...
     * make it possible to move a statement from one tree to another.
     * @method applyParent
  ...
  /**
    ...
    * Toggle or statement icons have anchors and can be focused on.
  ...
  /**
     * Count of nodes in a statement
     * @method getNodeCount
     * @return {int} number of nodes in the statement
     */
    getNodeCount: function() {
...
YAHOO.widget.MenuNode = function(oData, oParent, expanded) {
   ...
   /*
     * Menus usually allow only one statement to be open at a time.
     */
